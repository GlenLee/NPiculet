...
<script src="<%= ResolveClientUrl("~/scripts/admin.js") %>" type="text/javascript"></script>

<link href="<%= ResolveClientUrl("~/scripts/plugin/icheck/skins/all.css") %>" rel="stylesheet" type="text/css" />
<script src="<%= ResolveClientUrl("~/scripts/plugin/icheck/icheck.min.js") %>" type="text/javascript"></script>