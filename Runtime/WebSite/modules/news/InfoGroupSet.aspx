<%@ Page Title="信息组设置" Language="C#" MasterPageFile="~/modules/ContentPage.master" AutoEventWireup="true" CodeFile="InfoGroupSet.aspx.cs" Inherits="modules_news_InfoGroupSet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="toolbar" Runat="Server">
	<div class="tools">
		<ul class="toolbar">
			<li><asp:LinkButton ID="btnSave" runat="server" OnClick="btnSave_Click" CssClass="btn btn-default">保存</asp:LinkButton></li>
			<li><asp:LinkButton ID="btnAdd" runat="server" OnClick="btnAdd_Click" CssClass="btn btn-default">新增同级</asp:LinkButton></li>
			<li><asp:LinkButton ID="btnChild" runat="server" OnClick="btnChild_Click" CssClass="btn btn-default">新增下级</asp:LinkButton></li>
			<li><asp:LinkButton ID="btnDelete" runat="server" OnClick="btnDelete_Click" CssClass="btn btn-default">删除</asp:LinkButton></li>
		</ul>
	</div>
</asp:Content>
...
<asp:PlaceHolder ID="editor" runat="server">
				<table class="sui-table table-primary">
					<tr>
						<td class="th">编码</td>
						<td class="td"><asp:TextBox ID="GroupCode" runat="server" CssClass="input-large" Width="200px" MaxLength="64"></asp:TextBox>
