...
<head>
	...
	<style type="text/css">
		...
		.topleft .icon { display:inline-block;width:38px;height:36px;margin:3px 5px 3px 20px;background:url(../styles/admin/logo_small.png) no-repeat center center;background-size:36px;border-radius:18px; }
