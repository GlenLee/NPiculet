...
<head>
	...
	<style type="text/css">
		...
		.topleft .icon { display:inline-block;width:38px;height:36px;margin:3px 5px 3px 20px;background-image:url(../images/logo.png);background-size:36px;border-radius:18px; }
