...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	...
	<style type="text/css">
		html, body { margin:0;padding:0;width:100%;height:100%;background-color:#00c1ff; }
		div, p { text-align:center; }
		.dev { position: absolute;left:0;right: 0;top: 0;bottom:0;margin:0 auto;padding-top:80px;font-family:Tahoma,Verdana,"黑体";font-size:24pt;line-height:2em;color:#fff;z-index:999; }
		.container { position: absolute;left:0;right: 0;top: 0;bottom:0;z-index:1; }
		#output { opacity: 0.25; width: 100%; height: 100%; }
	</style>
</head>
