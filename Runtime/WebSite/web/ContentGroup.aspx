<%@ Page Title="" Language="C#" MasterPageFile="~/ContentPage.master" AutoEventWireup="true" CodeFile="ContentGroup.aspx.cs" Inherits="web_ContentGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="Server">
	<ul class="sui-breadcrumb">
		...
		<li class="active"><asp:Literal runat="server" ID="groupTitle"></asp:Literal></li>
	</ul>
