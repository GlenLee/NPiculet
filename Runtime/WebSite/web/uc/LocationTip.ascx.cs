...
public partial class web_uc_LocationTip : System.Web.UI.UserControl
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (Page.IsPostBack) 
			return;
		GroupCode = WebParmKit.GetRequestString("groupCode", "");
		string articleId = WebParmKit.GetRequestString("id", "");
