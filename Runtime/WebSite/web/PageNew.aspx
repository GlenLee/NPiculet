<%@ Page Title="" Language="C#" MasterPageFile="~/ContentPage.master" AutoEventWireup="true" CodeFile="PageNew.aspx.cs" Inherits="web_PageNew" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="Server">
    <div class="sui-row sui-row-fluid">
        <div class="span3">
            <!-- 侧边栏 开始 -->
			<uc1:ContentSidebar runat="server" id="ContentSidebar" Active="PageNew" />
            <!-- 侧边栏 结束 -->
        </div>
        <div class="span9">
            ...
            <!-- 列表 开始 -->
			<uc1:ContentList runat="server" ID="ContentPage1" GroupCode="PageNew" />
            <!-- 列表 结束 -->
        </div>
    </div>
</asp:Content>
