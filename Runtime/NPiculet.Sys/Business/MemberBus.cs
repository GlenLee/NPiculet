...
namespace NPiculet.Logic.Business
{
	...
	, u.FailedCount, u.FailedDate, u.IsEnabled, u.IsDel, u.Status, u.Creator, u.CreateDate, u.UpdateDate
...
WHERE u.IsDel=0) t";
			...
			sql += (string.IsNullOrEmpty(orderBy)) ? " ORDER BY Id DESC" : " ORDER BY " + orderBy;
